        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-3">
              {["Agile/Scrum methodology", "2-week sprint cycles", "Daily standup meetings", "Sprint reviews & retrospectives"].map((item, i) => (
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Git version control", "Jira for project management", "Slack for communication", "Figma for design collaboration"].map((item, i) => (
                <li key={i} className="flex items-center space-x-2">
                  <CheckCircle className="w-5 h-5 text-primary" />
                  <span>{item}</span>
                </li>
